...
def build_model(beam_matrices, tumor_matrix, critical_matrix, treatment_upper_bound, treatment_lower_bound, pen_tumor, pen_crit):
    ...
    s_r = model.continuous_var_matrix(keys1=beam_matrices.num_rows, keys2=beam_matrices.num_columns, name="critical_relax")
...
if True == True:
    ...
    model_1 = build_model(beam_matrices=beam, tumor_matrix=tumor, critical_matrix=critical,
                          ...
                          pen_tumor=100_000, pen_crit=100_000)
    s = model_1.solve()
    ...
    print_result("p2_results_actual.out", x_vars, beam)